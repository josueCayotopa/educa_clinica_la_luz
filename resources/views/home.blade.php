        ...
        <div class="container mx-auto px-4 md:px-10">
            ...
            <div class="max-w-5xl mx-auto mb-16">
                <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
                    <div class="video-container">
                        ...
                        <iframe src="https://www.youtube.com/embed/TU_VIDEO_GLAUCOMA_ID_AQUI" title="Video Programa Glaucoma" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                        </iframe>
                    </div>
            ...
            <div class="mb-16">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="doctor-card bg-white rounded-xl shadow-lg overflow-hidden">
                        <img src="{{ asset('images/Dr Yoanner Martin.jpeg') }}" alt="Dr. Yoaner Martín Perera" class="doctor-image">
                        <div class="p-5">
                            ...
                            <p class="text-gray-600 text-sm mb-3">
                                Médico- Subespecialización en Glaucoma | Oftalmología
                                Instituto Cubano de Oftalmología, La Habana. Cuba

                                <span class="">Subespecialización en Catarata y Segmento Anterior |
                                    Oftalmología Instituto Cubano de Oftalmología, La Habana. Cuba</span>

                                Especialista en Oftalmología | Medicina
                    ...
                    <!-- Dra. Meida Espinoza -->
                    <div class="doctor-card bg-white rounded-xl shadow-lg overflow-hidden">
                        <img src="{{ asset('images/dra-espinoza-1.jpg') }}" alt="Dra. Meida Espinoza" class="doctor-image">
                        <div class="p-5">
                    ...
                    <!-- Dra. Ana Villacorta -->
                    <div class="doctor-card bg-white rounded-xl shadow-lg overflow-hidden">
                        <img src="{{ asset('images/dra-ana-villacorta.jpg') }}" alt="Dra. Ana Villacorta" class="doctor-image">
                        <div class="p-5">
            ...
            <div class="max-w-7xl mx-auto" id="plan-curricular-glaucoma">
                <div class="bg-white rounded-2xl shadow-2xl overflow-hidden border-2 border-gray-100">
                    ...
                    <div class="bg-gradient-to-r from-secondary to-secondary-900 p-4">
                        <div class="flex flex-wrap justify-center gap-3">
                            <button onclick="showModuleCategory('fundamentos')" id="tab-fundamentos" class="module-tab active px-6 py-3 rounded-lg font-bold text-white bg-primary transition-all duration-300">
                                <i class="fas fa-book mr-2"></i>
                                Fundamentos (4)
                            </button>
                            <button onclick="showModuleCategory('diagnostico')" id="tab-diagnostico" class="module-tab px-6 py-3 rounded-lg font-bold text-white bg-secondary-700 hover:bg-primary transition-all duration-300">
                                <i class="fas fa-eye mr-2"></i>
                                Diagnóstico por Imágenes (4)
                            </button>
                            <button onclick="showModuleCategory('tipos')" id="tab-tipos" class="module-tab px-6 py-3 rounded-lg font-bold text-white bg-secondary-700 hover:bg-primary transition-all duration-300">
                                <i class="fas fa-clipboard-list mr-2"></i>
                                Tipos de Glaucoma (17)
                            </button>
                            <button onclick="showModuleCategory('tratamiento')" id="tab-tratamiento" class="module-tab px-6 py-3 rounded-lg font-bold text-white bg-secondary-700 hover:bg-primary transition-all duration-300">
                                <i class="fas fa-syringe mr-2"></i>
                                Tratamiento (2)
                            </button>
                            <button onclick="showModuleCategory('cirugia')" id="tab-cirugia" class="module-tab px-6 py-3 rounded-lg font-bold text-white bg-secondary-700 hover:bg-primary transition-all duration-300">
                                <i class="fas fa-scalpel mr-2"></i>
                                Cirugía (9)
                            </button>
                            <button onclick="showModuleCategory('investigacion')" id="tab-investigacion" class="module-tab px-6 py-3 rounded-lg font-bold text-white bg-secondary-700 hover:bg-primary transition-all duration-300">
                    ...
                    <div class="p-8 md:p-12">
                        ...
                        <div id="content-tipos" class="module-content hidden">
                            ...
                            <!-- Subtabs -->
                            <div class="flex flex-wrap gap-2 mb-6">
                                <button onclick="showGlaucomaSubtab('primario')" id="subtab-primario" class="glaucoma-subtab active-subtab px-4 py-2 rounded-lg font-semibold text-white bg-primary text-sm">
                                    Primario (4)
                                </button>
                                <button onclick="showGlaucomaSubtab('secundario')" id="subtab-secundario" class="glaucoma-subtab px-4 py-2 rounded-lg font-semibold text-secondary bg-gray-100 text-sm hover:bg-gray-200">
                                    Secundario (11)
                                </button>
                                <button onclick="showGlaucomaSubtab('congenito')" id="subtab-congenito" class="glaucoma-subtab px-4 py-2 rounded-lg font-semibold text-secondary bg-gray-100 text-sm hover:bg-gray-200">
                        ...
                        <div id="content-cirugia" class="module-content hidden">
                            ...
                            <!-- Subtabs cirugía -->
                            <div class="flex flex-wrap gap-2 mb-6">
                                <button onclick="showCirugiaSubtab('laser')" id="subtab-laser" class="cirugia-subtab active-subtab px-4 py-2 rounded-lg font-semibold text-white bg-primary text-sm">
                                    Láser (3)
                                </button>
                                <button onclick="showCirugiaSubtab('filtrante')" id="subtab-filtrante" class="cirugia-subtab px-4 py-2 rounded-lg font-semibold text-secondary bg-gray-100 text-sm hover:bg-gray-200">
                                    Cirugía Filtrante (2)
                                </button>
                                <button onclick="showCirugiaSubtab('valvulas')" id="subtab-valvulas" class="cirugia-subtab px-4 py-2 rounded-lg font-semibold text-secondary bg-gray-100 text-sm hover:bg-gray-200">
                                    Válvulas (2)
                                </button>
                                <button onclick="showCirugiaSubtab('migs')" id="subtab-migs" class="cirugia-subtab px-4 py-2 rounded-lg font-semibold text-secondary bg-gray-100 text-sm hover:bg-gray-200">
                                    MIGS (2)
                                </button>
                            </div>
